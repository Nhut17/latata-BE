...
exports.updateDefault = catchAsyncError( async (req,res,next) => {
    ...
    const { id,name,phone,address_default,address } = req.body
    ...
    if(!addressIndex){
       return next(new ErrorHandler('Address default not found', 404))
    }
    ...
    addressModel.addresses[updateIndex].name = name
    addressModel.addresses[updateIndex].phone = phone
    addressModel.addresses[updateIndex].address = address
    addressModel.addresses[updateIndex].address_default = address_default
    console.log(addressModel.addresses[updateIndex].address_default)
