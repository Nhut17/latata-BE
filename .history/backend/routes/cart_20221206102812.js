...
const { addToCart, getCart,deleteCart, decreaseQuantity } = require('../controllers/cartController')
...
router.route('/cart/decrease/:id').delete(isAuthenticatedUser,decreaseQuantity)
