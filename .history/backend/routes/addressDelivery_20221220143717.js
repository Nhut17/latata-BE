...
const { addAddress, updateDefault, getAddress, get } = require('../controllers/addressDeliveryController')
...
router.route('/address/all').get(isAuthenticatedUser, authorizeRoles('user'),)
