...
const ListBlockAccessories = ({listProduct}) => {
    ...
    const mouseGaming = subProduct(listProduct,'Chuột máy tính').slice(0,5)
    const keyboard = subProduct(listProduct,'Bàn phím').slice(0,5)

    const listGaming = [...keyboard, ...mouse]
