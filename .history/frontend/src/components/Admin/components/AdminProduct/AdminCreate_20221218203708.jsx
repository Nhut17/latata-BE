...
// hanlde up image
 ...
 const find = listCate.findIndex(item => item.name === subCategories)
 const temp = listCate[find]?.sub_category?.length
console.log(find)
console.log(temp)
  // create product
                ...
                temp > 0 &&
                  <div className="input-group">
                        ...
                        <select
                          ...
                          {listCate[find].sub_category.map(item => (
                            <option value={item?.sub_category}>{item?.name}</option>
                          ))}
                        </select>        
