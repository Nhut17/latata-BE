                        ...
                        <div className="input-email">
                            ...
                            <input 
                                    ...
                                    {...register('email',{
                                      ...
                                      {
                                        errors.email?.type === 'pattern' &&  <span className='err-msg'>{errors.message}</span>
                                        }
                        </div>
                        ...
                        <div className="input-repeat-password">
                            ...
                            <input 
                                    ...
                                    {...register('repeatPassword', {
                                     ...
                                     {
                                        errors.repeatPassword?.type === 'required' &&  <span className='err-msg'>Mời bạn nhập email</span>
                                        }
                        </div>
                        </div>
