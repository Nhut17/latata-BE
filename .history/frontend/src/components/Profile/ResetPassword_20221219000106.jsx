                    ...
                    <div className="input-group">
                        ...
                        <input type="password" 
                                {...register("password",{
                                  ...
                                  {
                                errors.password?.type === 'required' &&  <span className='err-msg'>Mời bạn nhập họ tên</span>
                            }
                    </div>
                    ...
                    <div className="input-group">
                        ...
                        <input type="password" 
                                {...register("comfirmPassword",{
                                  ...
                                  {
                                errors.comfirm-password?.type === 'required' &&  <span className='err-msg'>Mời bạn nhập họ tên</span>
                            }
                    </div>
