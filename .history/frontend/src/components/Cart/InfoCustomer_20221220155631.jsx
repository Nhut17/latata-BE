    ...
    <>
        <div className='info-customer'>
            ...
            <div className="name input"  >
                <input 
                    type="text" 
                    defaultValue={addressCurrent[0]?.name}
            ...
            <div className="number input">
                <input 
                    type="text"  
                    defaultValue={addressCurrent[0]?.phone}
                    ...
                    />
                    <span className='style-change' htmlFor='number' style={transform: 'translate(15px,-15px)',
                    fontSize: 14,
                    backgroundColor:'white',
