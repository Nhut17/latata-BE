...
const ModalListAddress = ({ showAddress, setShowAddress, listAddress }) => {
    ...
    // const [addressDefault,setAddressDefault] = useState(listAddress ? listAddress?.filter(val => val?.address_default == 1 ) : '')
    console.log('address: ' + JSON.stringify(addressDefault))
