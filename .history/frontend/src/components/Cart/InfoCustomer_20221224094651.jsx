...
const InfoCustomer = ({totalPrice}) => {
   ...
   const [name,setName] = useState(addressCurrent ? addressCurrent[0]?.name : '')
   const [phone,setPhone] = useState(addressCurrent ? addressCurrent[0]?.phone : '')
    ...
    <>
        <div className='info-customer'>
            ...
            <div className="name input"  >
                <input 
                    type="text" 
                    value={addressCurrent ? addressCurrent[0]?.name : ''}
            ...
            <div className="number input">
                <input 
                    type="text"  
                    value={addressCurrent ? addressCurrent[0]?.phone : ''}
                    {...register('phoneNo',{
                        required: true,
