...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      {/* LOGIN */}
      <Route path='/dang-nhap'  ele={Login}/>

      {/* TABLET */}
      <Route path='/tablet'  ele={Tablet} />

      <Route path='/dang-ky'  ele={Register} />
      
      {/* WATCHES */}
      <Route path='/dong-ho'  ele={Watch} />

      <Route path='/empty-cart'  ele={EmptyCart} />


      {/* SMART PHONE */}
      <Route path='/dien-thoai'  ele={SmartPhone} />

      {/* SMART TV */}
      <Route path='/tv'  ele={SmartTV} />


      {/* ACCESSORIES  */}
      <Route path='/phu-kien'  ele={Acessories} />


      {/* SMART WATCH  */}
      <Route path='/smart-watch'  ele={SmartWatch} />

      {/* CART */}
      <Route path='/cart'  ele={CheckoutCart} />

      {/* LAPTOP */}

      <Route path='/laptop'  ele={Laptop} />

      {/* SMARTHOME */}
      <Route path='/smart-home'  ele={SmartHome} />
      

      {/* PRODUCT DETAIL */}
      <Route path='/product-detail'  ele={ProductDetail} />


      {/* ADMIN */}
      <Route path='/admin'  ele={Admin} />

      {/* <Route path="/admin/orders"  ele={Orders} /> */}
