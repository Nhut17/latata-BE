...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      {/* WATCHES */}
      <Route path='/dong-ho'  component={Watch} />

      <Route path='/empty-cart'  component={EmptyCart} />


      {/* SMART PHONE */}
      <Route path='/dien-thoai'  component={SmartPhone} />

      {/* SMART TV */}
      <Route path='/tv'  component={SmartTV} />


      {/* ACCESSORIES  */}
      <Route path='/phu-kien'  component={Acessories} />


      {/* SMART WATCH  */}
      <Route path='/smart-watch'  component={SmartWatch} />
