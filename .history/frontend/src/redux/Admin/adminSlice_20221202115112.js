...
export const deleteProduct = createAsyncThunk('admin/product/delete', 
                async(id,thunkAPI) => {
                    try{
                        ...
                        const res = await api.delete(`http://localhost:4000/api/v1/admin/product/${id}
                            `)
...
export const createProduct = createAsyncThunk('admin/product/create',
                 async(data,thunkAPI) => {
                        try{
                            ...
                            const res = await axios.post(`http://localhost:4000/api/v1/admin/product/new`,data,config)
