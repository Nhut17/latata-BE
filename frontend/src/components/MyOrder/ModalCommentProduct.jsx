                ...
                <form onSubmit={handleSubmit(onHandleSubmit)}>
                    ...
                    <div className='add-new-rating'>
                        ...
                        <div className='product-infor'>
                            <div className="img" style={{ backgroundImage: `url(https://bizweb.dktcdn.net/100/116/615/products/iphone-13-blue-select-2021-2326286d-bcaa-42fe-8ce6-629538ab251a.png?v=1646816034187)` }}>
                                <span>2</span>
                            </div>
                            <div className="up">
                                <div className='product-name'>iphone 13</div>
                                <div className='product-price'>{'1000000'.toString()
